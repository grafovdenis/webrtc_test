...
class EchoTestController extends GetxController {
  ...
  Future<void> echotest() async {
    try {
      if (_clientPub == null) {
        _signalLocal = ion.JsonRPCSignal("wss://11268deb8d67.ngrok.io/ws");
      ...
      if (_clientSub == null) {
        _signalRemote = ion.JsonRPCSignal('wss://11268deb8d67.ngrok.io/ws');
        _clientSub =
            await ion.Client.create(sid: 'test session', signal: _signalRemote, config: {
            'iceServers': [
              {'urls': 'stun:stun.l.google.com:19302'},
            ],
            'sdpSemantics': 'unified-plan'});
